...
# Configuration
INPUT_URL <- "https://raw.githubusercontent.com/dwillis/wbb-rosters/refs/heads/main/rosters_2025-26.csv"
...
teams |> anti_join(roster_teams, by = "ncaa_id") |> 
  select(ncaa_id, team)
...
na_positions <- wbb_rosters %>%
  filter(is.na(position)) %>%
  distinct(ncaa_id, team)
...
print(head(conference_transfers, 20))
```
